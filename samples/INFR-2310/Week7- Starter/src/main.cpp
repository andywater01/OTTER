...
bool initGLFW() {
	...
	window = glfwCreateWindow(800, 800, "100744494_Andrew_Waterhouse_Textures", nullptr, nullptr);
...
int main() {
	...
	Texture2DData::sptr NewTextureMap = Texture2DData::LoadFromFile("images/box.bmp");
	...
	Texture2D::sptr NewTexture = Texture2D::Create();
	NewTexture->LoadData(NewTextureMap);
