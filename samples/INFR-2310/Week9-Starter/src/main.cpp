...
bool initGLFW() {
	...
	window = glfwCreateWindow(800, 800, "100744494_Waterhouse", nullptr, nullptr);
...
int main() {
	...
	// Push another scope so most memory should be freed *before* we exit the app
	{
		...
		material1->Shader = reflectiveShader;
		...
		material1->Set("u_Reflectivity", diffuse2);
		...
		GameObject obj4 = scene->CreateEntity("moving_box");
		{
			...
			obj4.emplace<RendererComponent>().SetMesh(vao).SetMaterial(material1);
