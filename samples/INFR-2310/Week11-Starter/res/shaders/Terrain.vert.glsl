...
void main() {
	...
	outTexWeights = vec4(
		...
		min(GetTextureWeight(height, lowerEdge.x, upperEdge.x), smoothstep(height, upperEdge.y, lowerEdge.y)),
		min(GetTextureWeight(height, lowerEdge.y, upperEdge.y), smoothstep(height, upperEdge.z, lowerEdge.z)),
