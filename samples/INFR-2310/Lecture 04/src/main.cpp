...
int main() {
	...
	glm::mat4 View = glm::lookAt(
		glm::vec3(0, 0, 3), // cam pos
		glm::vec3(0 ,0 ,0), // camera look angle
		glm::vec3(0, 1, 0)); // up vector

	//Model Matrix
	glm::mat4 Model = glm::mat4(1.0f); // resetting matrix
	...
	// Handel for our mvp matrix (Uniform variable)
	...
	while (!glfwWindowShouldClose(window)) {
		...
		//Lecture 04
		Model = glm::mat4(1.0f);
		keyboard(); //roty = 0.1 then 0.2 then 0.3...
